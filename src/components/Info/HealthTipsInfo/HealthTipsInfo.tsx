    ...
    <div>
      ...
      <Modal isOpen={modal} toggle={toggle} className='mt-5'>
        ...
        <ModalBody className='text-center'>
          <p>
            According to the entered data you <b>{info}</b> in{' '}
            <b>{days} days</b>, which forces you to change your body weight by{' '}
            <b>{(kgAmount / days).toFixed(2)}kg per day</b> (
            <b>{((kgAmount / days) * 7).toFixed(2)}kg per week</b>)
          </p>
          <div>
            ...
            {rapidWeightChange ? (
              <p style={{ color: 'red', fontWeight: 'bold' }}>
                ...
                down to prevent side effects, like yo-yo effect. <br />
        ...
        <ModalFooter>
          ...
          {rapidWeightChange && (
            <Button color='warning' onClick={() => clearFinish()}>
              Change finish date
            </Button>
          )}
        </ModalFooter>
