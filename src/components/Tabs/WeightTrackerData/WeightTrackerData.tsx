    ...
    .map((item: { date: string; weight: number }, index: number) => {
      ...
      return (
        <tr key={item.date}>
          ...
          <td style={{ color: rangeBMIColor(itemBMI), fontWeight: 'bold' }}>
            {itemBMI}
          </td>
    ...
    <div>
      ...
      <TabContent activeTab={activeTab}>
        ...
        <TabPane tabId='History'>
          <Row>
            <Col sm='12'>
              <p className='h6 text-center my-3'>Check your weight log</p>
            </Col>
          </Row>
          <Table size='sm' striped>
            ...
            <tbody className='text-center'>{historyItems}</tbody>
          </Table>
        </TabPane>
        ...
        <TabPane tabId='Stats'>
          <Row>
            <Col sm='12'>
              <div className='h6 text-center my-3'>Some statistics...</div>
            </Col>
          </Row>
          <div className='h6 my-1'>
            <p>
              You already <b>{loseOrGain(userData)}</b>
            </p>
            <p>
              Average weight in actual week:{' '}
              <b>
                {thisWeekAvg}
            ...
            <p>
              Average weight one week before:{' '}
              <b>
                {lastWeekAvg}
            ...
            <p>
              Average weight two weeks before:{' '}
              <b>
                {beforeLastWeekAvg}
...
export default WeightTrackerData;
