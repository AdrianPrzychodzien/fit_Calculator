...
// BMI equations
//
export const calcBMI = (data: SetUserDataInterface): number => {
...
export const idealBMI = (data: SetUserDataInterface): number[] => {
  const height = data.height / 100;
...
export const userBmiTip = (data: SetUserDataInterface): string => {
...
//
export const maxHeartRate = (data: SetUserDataInterface): number => {
  let result;
  if (data.sex === 'Male') {
...
//
export const MifflinStJeor = (data: SetUserDataInterface): number => {
...
export const HarrisBenedict = (data: SetUserDataInterface): number => {
  let output = Math.round(
...
export const KatchMcardle = (data: SetUserDataInterface): number => {
  let output = Math.round(
...
export const restingMifflinStJeor = (data: SetUserDataInterface): number => {
...
export const restingHarrisBenedict = (data: SetUserDataInterface): number => {
  let result;
  if (data.sex === 'Male') {
    result =
...
export const restingKatchMcardle = (data: SetUserDataInterface): number => {
...
export const bodyFatFormula = (
  circumData: { waist: number; hips: number; neck: number },
  userData: SetUserDataInterface
) => {
  let { waist, neck, hips } = circumData;
...
export const displayAverageWeight = (
  ...
  const listofWeights = (
    ...
    let list = myObjects.filter((item: { date: string; weight: number }) => {
